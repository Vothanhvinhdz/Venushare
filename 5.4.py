...
"""
    ...
    p = 20  # bạn có thể chỉnh tuỳ ý

    while (p > 1):
        p -= 1
        print(f'\033[0;34m[💮VINHTOOL💮]\033[1;32m[|][LO......][{p}]', end='\r'); sleep(1/6)
        print(f'\033[0;34m[💮VINHTOOL💮]\033[1;32m[/][LOA.....][{p}]', end='\r'); sleep(1/6)
        print(f'\033[0;34m[💮VINHTOOL💮]\033[1;32m[-][LOAD....][{p}]', end='\r'); sleep(1/6)
        print(f'\033[0;34m[💮VINH TOOL💮]\033[1;32m[+][LOADI...][{p}]', end='\r'); sleep(1/6)
        print(f'\033[0;34m[💮VINHTOOL💮]\033[1;32m[\\][LOADIN..][{p}]', end='\r'); sleep(1/6)
        print(f'\033[0;34m[💮VINHTOOL💮]\033[1;32m[|][LOADING.][{p}]', end='\r'); sleep(1/6)
